...
*/
var myCurrentAccountBalance: Int = 800
print("Rayshawns bank account balance as of August 29th, 2016 is $\(myCurrentAccountBalance).")
...
*/
print("I just got a new puppy named \(theNameOfMyNewPuppy) and she is awesome!")
...
*/
print("I have $\(myCurrentAccountBalance) in my bank account.")
...
*/
myCurrentAccountBalance = 800 + 100
print("I now have $\(myCurrentAccountBalance).")
...
*/
// No I cant change it. I will get an error message because i already declared her name a constant. Constants are for forever!!!
